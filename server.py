...
if __name__ == "__main__":
    # Register tools
    mcp.add_tool(lookup_a_record)
    mcp.add_tool(lookup_aaaa_record)
    mcp.add_tool(lookup_mx_record)
    mcp.add_tool(lookup_txt_record)
    mcp.add_tool(lookup_ns_record)
    mcp.add_tool(lookup_cname_record)
    mcp.add_tool(lookup_ptr_record)
    mcp.add_tool(lookup_any_record)
