...
def test_dns_tools():
    ...
    a_records = lookup_a_record.fn(domain)
    ...
    mx_records = lookup_mx_record.fn(domain)
    ...
    ns_records = lookup_ns_record.fn(domain)
